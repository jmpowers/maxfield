...
purrr::walk(names(alldata), ~write_tsv(alldata[[.]], paste0("data_cut/",., ".tsv"), na=""))
```
...
# Models for replicated split-plot design

This is a split-plot analysis of traits averaged for each plant and year, specified as:
...
# Models with snowmelt date and total summer precipitation
...
* *VWC*, the summer mean of the approximately weekly mean volumetric water content in a subplot. 
...
## Number of years plants flowered
