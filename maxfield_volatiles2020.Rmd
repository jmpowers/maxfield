...
```{r random_sampling}
ggplot(vt, aes(x=sampledate, fill=water)) + geom_bar() + facet_wrap(vars(year), ncol=1, scales="free_x") + scale_fill_manual("Precipitation", values=water_pal) + theme_minimal()

ggplot(vt, aes(x=sampledate, fill=snow)) + geom_bar() + facet_wrap(vars(year), ncol=1, scales="free_x") + scale_fill_manual("Snowmelt", values=snow_pal) + theme_minimal()
