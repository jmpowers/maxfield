...
### FLoral plasticity: absolute snowmelt date and summed summer precip
...
for(tr in traits) {
  ...
  mt.mod.subplot[[tr]] <- lmer(mnps.subplot[[tr]] ~ melt_date + water + early_precip_mm + melt_date:water + early_precip_mm:water + (1|plot), data=mnps.subplot)
  mnps.subplot[[paste0("fit.",tr)]] <- NA
  mnps.subplot[[paste0("fit.",tr)]][!is.na(mnps.subplot[[tr]])]<- predict(mt.mod.subplot[[tr]], re.form=NA)
  mt.mod.subplot.test[[tr]] <- anova(mt.mod.subplot[[tr]])
  
    #Z-score the data first to get standardized slopes
  mt.mod.subplot[[tr]] <- lmer(scale(mnps.subplot[[tr]]) ~ melt_date + water + early_precip_mm + melt_date:water + early_precip_mm:water + (1|plot), data=mnps.subplot)
