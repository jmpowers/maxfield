...
ggplot(sm, aes(x=yday(date))) + 
  ...
  geom_point(data=ph, aes(y= height_cm/2), color="grey")+
  ...
  labs(title="Timing of measurements", subtitle="VWC (black) / Morphology (purple) / Nectar (orange)", x="Day of year", shape="Snow", linetype="Snow", y="Measurements")+
...
ph %>% group_by(year, snow, water, julian) %>% summarize_at(c("open","buds"), mean) %>% 
