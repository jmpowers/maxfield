...
ggplot(sds20.date.zeroed, aes(x=julian, y=prop_fly, color=water, shape=snow, linetype=snow))+geom_jitter(width=2, height=0) + stat_summary(fun="mean", geom="line") + scale_color_manual(values=water_pal)+
  labs(y="Proportion of nonaborted fruits with flies", x="Day of year", color="Precipitation", shape="Snow", linetype="Snow")+ scale_linetype_manual(values=c(2,1)) +
